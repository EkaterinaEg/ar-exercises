...
@store2.employees.create(first_name: "Kate", last_name: "Smith", hourly_rate: 160)
@store2.employees.create(first_name: "Anna", last_name: "Doe", hourly_rate: 30)
@store1.employees.create(first_name: "John", last_name: "Doeh", hourly_rate: 230)